...
سرورنت ریموت (Servernet Remote) نرم‌افزاری برای کارکردن با رایانه‌ی رومیزی از راه دور است که بر پایه‌ی پروژه‌ی متن‌باز RustDesk و با زبان برنامه‌نویسی Rust توسعه یافته است. نیاز به تنظیمات چندانی ندارد و شما را قادر می سازد تا بدون نگرانی از امنیت اطلاعات خود بر آن‌ها کنترل کامل داشته باشید.
