...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Website", "وب سایت"),
        ("About", "درباره"),
        ("Slogan_tip", "طراحی و توسعه‌یافته توسط تیم سرورنت"),
        ...
        ("install_tip", "لطفا برنامه را نصب کنید UAC و جلوگیری از خطای سرورنت ریموت برای راحتی در استفاده از نرم افزار"),
        ("Click to upgrade", "برای ارتقا کلیک کنید"),
        ("Configure", "تنظیم"),
        ("config_acc", "بدهید \"access\" مجوز سرورنت ریموت برای کنترل از راه دور دسکتاپ باید به"),
        ("config_screen", "بدهید \"screenshot\" مجوز سرورنت ریموت برای کنترل از راه دور دسکتاپ باید به"),
        ...
        ("android_input_permission_tip1", "استفاده کند \"Accessibility\" اجازه دهید از ویژگی سرورنت ریموت شما را از طریق ماوس یا صفحه ی لمسی کنترل کند، باید به Android برای اینکه یک دستگاه از راه دور بتواند دستگاه"),
        ("android_input_permission_tip2", "را پیدا کنید و فعال نمایید \"Servernet Remote Input\" بشوید ، سپس گزینه \"Installed Services\" وارد قسمت \"Accessibility\" در صفحه تنظیمات "),
        ...
        ("Turned off", "خاموش شد"),
        ("Language", "زبان"),
        ("Keep RustDesk background service", "سرویس سرورنت ریموت را در پس‌زمینه نگه دارید"),
        ...
        ("Show RustDesk", "نمایش سرورنت ریموت"),
        ("This PC", "This PC"),
        ("or", "یا"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "برای کنترل دسکتاپ از راه دور با صفحه کلید، باید مجوز سرورنت ریموت \"Input Monitoring\" را بدهید."),
        ("config_microphone", "برای صحبت از راه دور، باید مجوز \"Record Audio\" را به سرورنت ریموت بدهید."),
        ...
        ("still_click_uac_tip", "همچنان کاربر از راه دور نیاز دارد که روی OK در پنجره UAC اجرای سرورنت ریموت کلیک کند."),
        ...
        ("verify_rustdesk_password_tip", "رمز عبور سرورنت ریموت را تأیید کنید"),
        ...
        ("scam_text1", "اگر با شخصی که نمی‌شناسید و به او اعتماد ندارید صحبت می‌کنید و از شما خواسته است از سرورنت ریموت استفاده کنید و سرویس را راه‌اندازی کنید، ادامه ندهید و بلافاصله تلفن را قطع کنید"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "لطفا سرورنت ریموت را به نسخه {} یا جدیدتر ارتقا دهید"),
        ...
        ("selinux_tip", "SELinux روی دستگاه شما فعال است، که ممکن است از اجرای صحیح سرورنت ریموت به عنوان کنترل‌شده جلوگیری کند"),
        ...
        ("powered_by_me", "Powered by Servernet.Cloud"),
        ...
        ("allow-only-conn-window-open-tip", "زمانی که پنجره سرورنت ریموت باز است، اتصال برقرار شود"),
        ...
        ("floating_window_tip", "این به حفظ سرویس پس‌زمینه سرورنت ریموت کمک می‌کند"),
        ...
        ("About RustDesk", "درباره سرورنت ریموت"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "لطفاً سرورنت ریموت را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
        ...
        ("allow-insecure-tls-fallback-tip", "به‌طور پیش‌فرض، سرورنت ریموت گواهی سرور را برای پروتکل‌ها با استفاده از TLS تأیید می‌کند.\nبا فعال بودن این گزینه، سرورنت ریموت دوباره مرحله تأیید را رد می‌کند و در صورت عدم موفقیت تأیید ادامه می‌دهد."),
        ("Disable UDP", "UDP غیر فعال کردن"),
        ("disable-udp-tip", "کنترل می کند که آیا فقط از TCP استفاده شود یا خیر.\nوقتی این گزینه فعال باشد، سرورنت ریموت دیگر از UDP 21116 استفاده نمی کند، به جای آن از TCP 21116 استفاده می شود."),
        ("server-oss-not-support-tip", "توجه: سرور سرورنت ریموت OSS این ویژگی را ندارد."),
